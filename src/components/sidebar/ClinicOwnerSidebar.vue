    ...
    const baseItems = [
      ...
      },
      {
        ...
        children: [
          ...
          { label: 'Approve Employees', icon: 'shield', to: '/owner/staff/approve', feature: 'staff_management', permission: 'staff:review' },
      ...
      },
      {
        ...
        feature: 'reports',
        children: [
          { label: 'Refunds', icon: 'card', to: '/finance/refunds', feature: 'reports', permission: 'refunds:review' },
          ...
          { label: 'Payroll Approval', icon: 'shield', to: '/finance/payroll-approval', feature: 'payroll', permission: 'payroll:review' },
