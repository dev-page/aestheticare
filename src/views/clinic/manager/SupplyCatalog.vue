        ...
        <div v-else class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
          ...
          >
            ...
            <div class="mt-3 text-xs text-slate-300 space-y-1">
              ...
              <p v-if="rec.estimatedCost > 0">Est. cost: <span class="text-white">₱ {{ rec.estimatedCost.toLocaleString('en-PH', { minimumFractionDigits: 2, maximumFractionDigits: 2 }) }}</span></p>
            </div>
          </div>
        </div>
      </div>
